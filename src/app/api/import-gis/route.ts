...
export async function POST(req: Request) {
  ...
  try {
    ...
    if (!importData) {
      return NextResponse.json({ error: 'Estructura de archivo JSON inválida' }, { status: 400 });
    }
    ...
    // 4. Importar Líneas de Transporte
    ...
    // 5. Importar Rutas de Transporte Pesado
